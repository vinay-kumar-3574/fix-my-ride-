...
const detectLocation = async () => {
  ...
  const handleFinish = async () => {
    try {
      ...
      // Combine signup data (if available from navigation state) with onboarding data
      const userData = {
        userId: userId,
        ...formData,  // your onboarding form data
        fullName: location.state?.name || formData.fullName,
